...
```{r}
fit1 = bvs(X, resp = y, prep = FALSE, family = "survival", mod_prior = "unif", niter = 100)
```
...
```{r}
fit2 = bvs(X, resp = y, prep = FALSE, family = "survival", mod_prior = "unif", niter = 100)
```
...
```{r}
fit3 = bvs(X, resp = y, prep = FALSE, family = "survival", mod_prior = "unif", niter = 100)
```
...
```{r}
fit4 = bvs(X, resp = y, prep = FALSE, family = "survival", mod_prior = "unif", niter = 100)
```
...
```{r}
fit5 = bvs(X, resp = y, prep = FALSE, family = "survival", mod_prior = "unif", niter = 100)
```
