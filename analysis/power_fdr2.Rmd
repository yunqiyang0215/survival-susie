...
for (i in 1:3){
  ...
  points(res.susie[which(ts == 0.95),2], res.susie[which(ts == 0.95), 1])
  points(res.svb[which(ts == 0.95),2], res.svb[which(ts == 0.95), 1])
  points(res.bvsnlp[which(ts == 0.95),2], res.bvsnlp[which(ts == 0.95), 1])
