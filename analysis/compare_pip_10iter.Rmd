...
for (i in 1:length(censor_lvls)){
  ...
  res.pip = compare_pip(pip.susie, pip.svb, susie$simulate.effect_indx, dat_indx = indx, p =1e3)
  ...
  res.pip = compare_pip(pip.susie, pip.r2b, susie$simulate.effect_indx, dat_indx = indx, p =1e3)
  plot_pip(res.pip, labs = c("susie", "r2b"), main = paste0("censor=",censor_lvls[i]))
  
  res.pip = compare_pip(pip.susie, pip.rss, susie$simulate.effect_indx, dat_indx = indx, p =1e3)
