...
4. Simulate survival time using exponential survival model. (New data simulation procedure)
...
pdf("/project2/mstephens/yunqiyang/surv-susie/survival-susie/output/pip_gtex.pdf", width= 12, height = 18)
par(mfrow = c(5,4))
...
pdf("/project2/mstephens/yunqiyang/surv-susie/survival-susie/output/pip_gtex_calibration.pdf", width= 12, height = 8)
par(mfrow = c(2,3))
