---
title: "Compare PIPs: small sample with more iterations"
author: "Yunqi Yang"
date: "4/6/2023"
...
1. susie: $L=5$ and estimate prior covariance. niter = 500.

2. bvsnlp: niter = 500.

3. survival svb and susie rss: niter = 1000

4. r2b was set to default number of iterations
...
```{r}
susie = readRDS("/project2/mstephens/yunqiyang/surv-susie/sim2024/sim_niter500/susie.rds")
svb = readRDS("/project2/mstephens/yunqiyang/surv-susie/sim2024/sim_niter500/svb.rds")
bvsnlp = readRDS("/project2/mstephens/yunqiyang/surv-susie/sim2024/sim_niter500/bvsnlp.rds")
r2b = readRDS("/project2/mstephens/yunqiyang/surv-susie/sim2024/sim_niter500/r2b.rds")
rss = readRDS("/project2/mstephens/yunqiyang/surv-susie/sim2024/sim_niter500/rss.rds")
```
