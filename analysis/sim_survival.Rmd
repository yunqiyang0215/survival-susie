...
4. $\log T_i = \beta_0+\beta_1x_{i1} + \beta_2x_{i2}+\epsilon_i$, and high correlation between $x_1$ and $x_2$, $x_1, x_2$ and other variables. 
...
#### Scenario 3: single effect model with highly correlated predictors
```{r}
set.seed(1)
n <- 100
p <- 50
...
#### Scenario 4: two effects model with highly correlated variables 
```{r}
set.seed(1)
n <- 100
p <- 50
