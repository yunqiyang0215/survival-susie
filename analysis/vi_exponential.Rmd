...
lower = c(-100, 1e-10)
upper = c(100, 30)
res1 <- update_q(x, y, d, h0 = 2, m = 1, v2 = 1, s2 = 1, maxiter = 10, tol = 0.1, lower, upper)
res1
```
...
lower = c(-50, 1e-8)
upper = c(50, 50)
res4 <- update_q(x[1:5], y[1:5], d[1:5], h0 = 10, m = 1, v2 = 1, s2 = 50, maxiter = 50, tol = 0.1, lower, upper)
head(res4)
tail(res4)
```
